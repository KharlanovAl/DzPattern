...
public class CardDiliveryTest {
    ...
    void shouldSuccessfulPlanAndReplanMeeting() {
        ...
        $(Selectors.byText("Запланировать")).click();
        $("[data-test-id=replan-notification] .notification__content").shouldHave(exactText("У вас уже запланирована встреча на другую дату. Перепланировать? " + secondMeetingDate)).shouldBe(visible);
